		...
		<div class="home text-xs-center" id="home">
			<v-container fluid class="ma-0 pa-0">
				<v-parallax height="700" src="./hero.jpg">
					<v-layout align-center column justify-center class="mt-5" dark>
						<p
							class="mt-2"
							:style="{
								fontSize: '50px',
		...
		<div id="portfolio" class="mt-5">
			...
			<v-layout row wrap align-center justify-center class="mb-5">
				<v-flex xs12 sm12 lg12>
					<p class="font-weight-thin mt-2 ml-4 mt-5" style="font-size:35px;">
						Side Projects
					</p>
				</v-flex>
				<v-flex xs12 sm6 md4 lg3 ma-3 v-for="sp in spCards" :key="sp.name">
					<v-card class="pa-2 shadow" data-aos="fade-up" data-aos-once="true" height="400px">
						...
						<v-card-actions>
							<v-layout align-center column justify-center>
								<v-btn dark v-bind:href="sp.link" medium color="blue-grey white--text">View</v-btn>
							</v-layout>
						</v-card-actions>
					</v-card>
				</v-flex>
			...
			<v-layout column class="mb-3">
				<v-flex xs12 sm12 lg12>
					<p class="font-weight-thin mt-2 ml-4" style="font-size:35px;">
						Technical Writing
					</p>
				</v-flex>
				<v-flex ma-3 v-for="techWriting in techWritingCards" :key="techWriting.heading">
					<v-card class="pa-2 shadow" data-aos="fade-up-left" data-aos-once="true">
						<v-card-title>
							<div>
								<h3 class="mb-2">
									{{ techWriting.heading }}
						...
						<div class="d-flex flex-row justify-content-between">
							...
							<v-card-actions>
								<v-layout row justify-end>
									<v-btn v-bind:href="techWriting.link" medium class="blue-grey white--text">Read More</v-btn>
								</v-layout>
							</v-card-actions>
						</div>
					</v-card>
			...
			<v-layout row wrap justify-center>
				<v-flex xs12 sm12 lg12>
					<p class="font-weight-thin mt-2 ml-4 mt-5 mb-5" style="font-size:35px;">
						Photography Works
					</p>
				</v-flex>
				<v-flex xs8 sm4 md3 ma-2 v-for="ph in phCards" :key="ph.heading">
					<v-hover v-slot="{ hover }">
						<v-card class="pa-2" :elevation="hover ? 8 : 2">
							<a :href="ph.link">
								<v-img v-bind:src="ph.img" height="300px"></v-img>
							</a>
						</v-card>
					</v-hover>
				</v-flex>
				...
				spCards: [
					{
						...
						img: "https://github.com/erxxx4321/HelloCurrency/raw/master/demo.png",
						content: "Currency exchange app built with VueJs, Vuex, Chart.js ...",
						link: "https://github.com/erxxx4321/HelloCurrency",
					},
					{
						heading: "Daily",
						img: "https://github.com/erxxx4321/Daily/raw/master/demo.png",
						content: "A news website which data is from New York Times API and built with ReactJS ...",
						link: "https://github.com/erxxx4321/Daily",
					},
					{
						heading: "Restaurant homepage - vanillaJS",
						img: "https://github.com/erxxx4321/restaurant/raw/master/demo.png",
						content: "One page restaurant website built with vanilla Javascript ...",
						link: "https://github.com/erxxx4321/restaurant",
					},
					{
						heading: "Simple Tic Tac Toe",
						img: "https://github.com/erxxx4321/simple-TicTacToe/raw/master/demo.png",
						content: "Tic Tac Toe game used JS factory function as design pattern ...",
						link: "https://github.com/erxxx4321/simple-TicTacToe",
					},
					{
						heading: "FirstTrade!",
						img:
							"https://ghcdspantherpost.org/wp-content/uploads/2021/04/stock-market-graph-trading-chart-for-business-and-finance-free-vector.jpg",
						content:
							"Stock market simulation game with Taiwan's history stock market data used dotnet MVC as the program ...",
						link: "https://github.com/erxxx4321/FirstTrade",
					},
				],
				techWritingCards: [
					{
					...
					},
					{
						...
						content: "要知道什麼是作用域之前，我們需要知道為什麼我們會需要作用域，讓我們回到作用域還沒出現的時候 ...",
						link:
							"https://medium.com/@erxxx4321/%E4%BD%9C%E7%94%A8%E5%9F%9F%E6%98%AF%E4%BB%80%E9%BA%BC-%E7%82%BA%E4%BB%80%E9%BA%BC%E6%88%91%E5%80%91%E9%9C%80%E8%A6%81%E4%BD%9C%E7%94%A8%E5%9F%9F-2361d1bd2d3b",
					...
					},
					{
						...
						link: "https://medium.com/@erxxx4321/%E4%BB%80%E9%BA%BC%E6%98%AF-crud-4bc669ba22b6",
						tags: ["CRUD", "增刪查改", "電腦程式", "動態網站"],
					},
					{
						heading: "MVC 是什麼？",
						content: "MVC是一種軟體設計的模式，它將程式切分成三個相互關聯的元件，個別負責不同的工作 ...",
						link: "https://medium.com/@erxxx4321/mvc-%E6%98%AF%E4%BB%80%E9%BA%BC-e5fc06554907",
						tags: ["Mvc Frameworks", "軟體設計", "程式設計"],
					},
					{
						heading: "從卡夫卡變形記談多型",
						content: "多型是物件導向程式設計的四大基本概念之一，原文是Polymorphism，”Poly”在古希臘文的意思是 ...",
						link:
							"https://medium.com/@erxxx4321/%E5%BE%9E%E5%8D%A1%E5%A4%AB%E5%8D%A1%E8%AE%8A%E5%BD%A2%E8%A8%98%E8%AB%87%E5%A4%9A%E5%9E%8B-1f247853640",
						tags: ["物件導向", "多型", "程式設計", "Polymorphism"],
					},
				],
				phCards: [
					{
